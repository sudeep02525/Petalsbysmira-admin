...
export default function NewCampaignPage() {
  ...
  const updateImageConfig = (index, field, value) => {
    setImages(prev => {
      const newImages = [...prev];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create configs payload corresponding to the files
      const imageConfigs = images.map((img, idx) => ({
        alt: img.alt,
        title: img.title,
        link: img.link,
        enabled: img.enabled,
      ...
      await axiosInstance.post("/admin/campaigns", submitData, {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Celebrate the bond with a thoughtful gift"
                  className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black"
                />
              </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-500 mb-4">Upload up to 20 images. The layout will adapt automatically. Drag images to reorder (or manage order below).</p>
            
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4">
              {images.map((img, index) => (
                <div key={index} className="relative border border-gray-200 rounded-lg overflow-hidden group bg-gray-50 flex flex-col">
                  ...
                  <div className="p-2 space-y-2 text-xs">
                    <input 
                      ...
                      value={img.link} 
                      onChange={(e) => updateImageConfig(index, 'link', e.target.value)}
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input 
                        type="checkbox" 
                        checked={img.enabled} 
                        onChange={(e) => updateImageConfig(index, 'enabled', e.target.checked)}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black"
                />
                <p className="text-xs text-gray-500 mt-1">Higher number shows first if multiple campaigns overlap.</p>
              </div>
            </div>
          </div>
